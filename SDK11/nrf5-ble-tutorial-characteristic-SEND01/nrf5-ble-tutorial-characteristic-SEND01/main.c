...
#define DEVICE_NAME                      "Patient Monitoring Dev"                          /**< Name of device. Will be included in the advertising data. */
...
static void timer_timeout_handler(void * p_context)
{
    ...
    data = Var ;
    our_termperature_characteristic_update(&m_our_service, &data);
